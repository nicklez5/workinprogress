...
public interface PlaylistService {
    ...
    String deletePlaylist(String uuId,String name) throws PlaylistException, UserException, CurrentUserException;
    String createPlaylist(String uuId, String name) throws UserException, CurrentUserException;
    Playlist renamePlaylist(String uuId, Integer playlist_id, String playlist_name) throws UserException, CurrentUserException;
    String clearPlaylist(String uuId, Integer playlist_id) throws UserException, CurrentUserException;
